...
--
-- Host: localhost
-- Generation Time: Jun 13, 2024 at 08:30 AM
...
INSERT INTO `Cart` (`cart_id`, `order_id`, `user_id`, `product_id`, `status`) VALUES
(1, 0, 1, 1, 'bought'),
(2, 0, 1, 18, 'bought'),
(3, 0, 1, 20, 'bought'),
(4, 0, 1, 16, 'bought'),
...
(1, 'Apple iPhone 15 128GB Black', 'Processor: Apple A16 Bionic  Memory: 6 GB  Disk SSD: 128 GB  Graphics Card: Apple GPU  Screen: 6,1\"  Operating system: iOS', 'Phone', 3),
(2, 'Google Pixel 8', 'Processor: Google Tensor G3\r\nMemory: 8 GB\r\nDisk SSD: 128 GB\r\nGraphics Card: Immortalis-G715s MC10\r\nScreen: 6,2\"\r\nOperating system: Android', 'Phone', 2),
(3, 'Samsung Galaxy A15', 'Processor: MediaTek Helio G99\r\nMemory: 4 GB\r\nDisk SSD: 128 GB\r\nGraphics Card: Mali-G57 MC2\r\nScreen: 6,5\"\r\nOperating system: Android & One UI', 'Phone', 4),
